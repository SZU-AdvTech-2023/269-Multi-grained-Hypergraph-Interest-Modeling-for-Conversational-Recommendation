...
def run_crslab(config, save_data=False, restore_data=False, save_system=True, restore_system=False,
    ...
    # 加载已训练的模型参数
    # checkpoint = torch.load("/data/xiaoyin/MHIM-main/MHIM/save/MHIM.pth")
    # CRS.model.load_state_dict(checkpoint['model_state_dict'])
