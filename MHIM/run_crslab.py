...
if __name__ == '__main__':
    ...
    parser.add_argument('-ss', '--save_system', action='store_true',
                        help='save trained system',  default=True)
    ...
    parser.add_argument('-e', '--pretrain_epoch', type=int, default=10, help='pretrain epoch')
    args, _ = parser.parse_known_args()
    print("args.seed: ",args.seed)
    print("args.save_system: ",args.save_system)
